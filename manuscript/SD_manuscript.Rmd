...
## Experiment 1
Posterior estimates of mean fitness for each group are plotted in Figure 1. Tables S1-S4 give sample sizes and summary statistics, and Tables S5-S8 present estimated differences between means (Table 1 is a summary of Tables S5-S8, which lists the significant differences only).

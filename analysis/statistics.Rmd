...
```{r}
tab_S2 <- larvae %>% group_by(SD, copies_of_SD, parent_with_SD) %>% 
...
tab_S7 %>% clean_table() %>% pander(split.cell = 40, split.table = Inf)
```
...
```{r}
saveRDS(tests_expt2, file = "output/tab_S10.rds")
